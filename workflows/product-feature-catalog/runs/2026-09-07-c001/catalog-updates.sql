BEGIN;
-- Weekly catalog maintenance run_id f2a9c4e1-6b83-4d17-9e50-20260907c001
-- REVIEW ONLY — do not apply without human approval (automation write policy).
-- Scope:
--   1) Material update: loyalty.forms.surveys (Forms.md banner_url + completion rewards; still unapplied from 2026-08-31)
--   2) Path-churn verifies: Reward.md (campaign reward relation layer) + Referral.md (notifications outbox)
--   3) Re-carry evidence-backed verify/repair set from unapplied 2026-08-31-c001 / 2026-08-17-c002
...
INSERT INTO _catalog_run VALUES ('f2a9c4e1-6b83-4d17-9e50-20260907c001');
