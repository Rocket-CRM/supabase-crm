BEGIN;
-- Weekly catalog maintenance run_id b8d4e1a2-7c95-4f31-9a60-20260914c001
-- REVIEW ONLY — do not apply without human approval (automation write policy).
-- Scope:
--   1) Material update: loyalty.forms.surveys (Forms.md banner_url + completion rewards via form reward BFFs;
--      still unapplied from 2026-08-31 / 2026-09-07 reviewable SQL)
--   2) Path-churn verifies (copy unchanged): Reward.md campaign reward relation layer; Referral.md notifications outbox
--   3) Re-carry evidence-backed verify/repair set from unapplied 2026-08-31-c001 / 2026-08-17-c002 / 2026-09-07-c001
--   4) No new mutations for Customer 360 wallet-lots registry churn (conflict — see SUMMARY.md)
...
INSERT INTO _catalog_run VALUES ('b8d4e1a2-7c95-4f31-9a60-20260914c001');
